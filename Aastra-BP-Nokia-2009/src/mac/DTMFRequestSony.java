...
public class DTMFRequestSony extends MIDlet implements CommandListener,
    ...
    dialBackCommand, freeTimeSendCommand, freeTimeBackCommand;
...
//---------------- EDITSETTINGFORM ---------------------------------------------
        ...
        AboutCommand = new Command("Om mobismaME", Command.HELP, 5);
        ...
        ExitCommandMainList = new Command("Avsluta", Command.OK, 2);
        ...
        try {
            ...
            Image image8a = Image.createImage("/icon/vidarekoppling24.png");
            Image image9a = Image.createImage("/icon/mex24red.png");
            ...
            mainList.append("Aktivera Mex", image8a);
            mainList.append("Deaktivera Mex", image9a);
